...
// var sign = sign_message(pri,'12222aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
// console.log(sign)
// console.log(verify_sign(pub,'12222aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',sign))
...
function create_key_to_cert(private_key,public_key_CA,cert) {
    ...
    if (B[1].mod(2).eq(0)){
        return {b:b,B: B[0].mul(10),check:check[0].eq(B[0])};
    }else{
        return {b:b,B:B[0].mul(10).add(1),check:check[0].eq(B[0])};
    }
...
// var client =  { private_key: bignum('59692656627571934054792570866978333350575981143308503786097578753621529310388'),
//     public_key: bignum('890074121410289253079379907903151305699370275175994900293904164388742310003021')}
// var ca = { private_key:bignum('100087159414148798571338198529702559367172473334495556687261701316134730228142'),
//     public_key: bignum('844748743084219035263582903208530701645841230114635882660023515059992152443260')}
